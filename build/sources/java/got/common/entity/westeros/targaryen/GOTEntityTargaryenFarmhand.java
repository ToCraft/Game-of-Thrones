...
public class GOTEntityTargaryenFarmhand extends GOTEntityTargaryenMan implements GOTFarmhand {
	public Item seedsItem;

	public GOTEntityTargaryenFarmhand(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (hiredNPCInfo.getHiringPlayer() == entityplayer) {
			return "westeros/targaryen/farmhand/hired";
		}
