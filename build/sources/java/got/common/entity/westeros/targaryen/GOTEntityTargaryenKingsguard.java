...
public class GOTEntityTargaryenKingsguard extends GOTEntityTargaryenLevyman {
	public GOTEntityTargaryenKingsguard(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			if (hiredNPCInfo.getHiringPlayer() == entityplayer) {
				return "westeros/targaryen/citywatch/hired";
			}
			return "westeros/targaryen/citywatch/friendly";
		}
		return "westeros/targaryen/citywatch/hostile";
	}
