...
public class GOTRecipe {
	...
	public static String[] dyeOreNames = new String[] { "dyeBlack", "dyeRed", "dyeGreen", "dyeBrown", "dyeBlue", "dyePurple", "dyeCyan", "dyeLightGray", "dyeGray", "dyePink", "dyeLime", "dyeYellow", "dyeLightBlue", "dyeMagenta", "dyeOrange", "dyeWhite" };
	...
	public static void createGiftRecipes() {
		...
		gift.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.giftHelmet), "XXX", "X X", Character.valueOf('X'), Items.leather));
		gift.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.giftChestplate), "X X", "YYY", "XXX", Character.valueOf('X'), Items.leather, Character.valueOf('Y'), "ingotIron"));
		gift.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.giftLeggings), "XXX", "Y Y", "X X", Character.valueOf('X'), Items.leather, Character.valueOf('Y'), "ingotIron"));
		gift.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.giftBoots), "X X", "X X", Character.valueOf('X'), Items.leather));
	...
	public static void createHillmanRecipes() {
		...
		hillmen.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.hillmenHelmet), "XXX", "Y Y", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), Items.leather));
		hillmen.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.hillmenChestplate), "X X", "YYY", "XXX", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), Items.leather));
		hillmen.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.hillmenLeggings), "XXX", "Y Y", "X X", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), Items.leather));
		hillmen.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.hillmenBoots), "Y Y", "X X", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'), Items.leather));
	...
	public static void createLhazarRecipes() {
		...
		lhazar.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.lhazarSpear), "  X", " X ", "X  ", Character.valueOf('X'), GOTRegistry.gemsbokHorn));
	...
	public static void createPoisonedDaggerRecipes() {
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.bronzeDagger, GOTRegistry.bronzeDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.ironDagger, GOTRegistry.ironDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.valyrianDagger, GOTRegistry.valyrianDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.westerosDagger, GOTRegistry.westerosDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.wildlingDagger, GOTRegistry.wildlingDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.essosDagger, GOTRegistry.essosDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.asshaiDagger, GOTRegistry.asshaiDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.alloySteelDagger, GOTRegistry.alloySteelDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.lhazarDagger, GOTRegistry.lhazarDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.sothoryosDagger, GOTRegistry.sothoryosDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.yitiDagger, GOTRegistry.yitiDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.summerDagger, GOTRegistry.summerDaggerPoisoned));
		GameRegistry.addRecipe(new GOTRecipePoisonWeapon(GOTRegistry.chisel, GOTRegistry.valyrianChisel, GOTRegistry.valyrianPowder));
	}
	...
	public static void createSmeltingRecipes() {
		...
		GameRegistry.addSmelting(GOTRegistry.oreCobalt, new ItemStack(GOTRegistry.cobaltBlue), 0.8f);
	...
	public static void createSothoryosRecipes() {
		...
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sothoryosHelmet), "XXX", "X X", Character.valueOf('X'), "ingotBronze"));
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sothoryosChestplate), "X X", "XXX", "XXX", Character.valueOf('X'), "ingotBronze"));
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sothoryosLeggings), "XXX", "X X", "X X", Character.valueOf('X'), "ingotBronze"));
		sothoryos.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sothoryosBoots), "X X", "X X", Character.valueOf('X'), "ingotBronze"));
	...
	public static void createSummerRecipes() {
		...
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.summerHelmet), "XXX", "Y Y", Character.valueOf('X'), "ingotBronze", Character.valueOf('Y'), Items.leather));
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.summerChestplate), "X X", "YYY", "XXX", Character.valueOf('X'), "ingotBronze", Character.valueOf('Y'), Items.leather));
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.summerLeggings), "XXX", "Y Y", "X X", Character.valueOf('X'), "ingotBronze", Character.valueOf('Y'), Items.leather));
		summer.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.summerBoots), "Y Y", "X X", Character.valueOf('X'), "ingotBronze", Character.valueOf('Y'), Items.leather));
	...
	public static void createUnsmeltingRecipes() {
		...
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sothoryosHelmetGold), "XXX", "X X", Character.valueOf('X'), "ingotGold"));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sothoryosChestplateGold), "X X", "XXX", "XXX", Character.valueOf('X'), "ingotGold"));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sothoryosLeggingsGold), "XXX", "X X", "X X", Character.valueOf('X'), "ingotGold"));
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.sothoryosBootsGold), "X X", "X X", Character.valueOf('X'), "ingotGold"));
		...
		unsmelt.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.mossovySword), "X", "X", "Y", Character.valueOf('X'), GOTRegistry.silverIngot, Character.valueOf('Y'), "stickWood"));
	...
	public static void createYiTiRecipes() {
		...
		yiti.add(new ShapedOreRecipe(new ItemStack(GOTRegistry.yitiBootsGold), "X X", "X X", Character.valueOf('X'), GOTRegistry.yitiSteelIngot));
	...
	public static void onInit() {
		...
		RecipeSorter.register("got:poisonWeapon", GOTRecipePoisonWeapon.class, RecipeSorter.Category.SHAPELESS, "after:minecraft:shapeless");
		...
		GOTRecipe.createPoisonedDaggerRecipes();
	...
	public static void registerOres() {
		...
		OreDictionary.registerOre("oreCobalt", GOTRegistry.cobaltBlue);
