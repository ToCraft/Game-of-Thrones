...
public abstract class GOTEnchantment {
	...
	public static GOTEnchantment protectValyrian = new GOTEnchantmentProtectionMithril("protectValyrian").setEnchantWeight(0);
	...
	public String getNamedFormattedDescription(ItemStack itemstack) {
		...
		s = isBeneficial() ? (EnumChatFormatting.GRAY) + s : (EnumChatFormatting.DARK_GRAY) + s;
		return s;
	}
