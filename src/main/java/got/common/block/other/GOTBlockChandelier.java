...
public class GOTBlockChandelier extends Block {
	...
	public String[] chandelierNames = new String[] { "bronze", "iron", "silver", "gold", "valyrian", "bronze", "bronze", "bronze", "bronze", "bronze", "bronze", "bronze", "asshai", "bronze", "bronze", "bronze" };
	...
	public boolean canBlockStay(World world, int i, int j, int k) {
		...
		if (block instanceof GOTBlockChain) {
			return true;
		}
