...
public class GOTConfig {
	...
	public static void load() {
		...
		alwaysShowAlignment = config.get(CATEGORY_GUI, "Always show alignment", false, "If set to false, the alignment bar will only be shown in the World of Game of Thrones. If set to true, it will be shown in all dimensions").getBoolean();
