	...
	public ItemStack transferStackInSlot(EntityPlayer entityplayer, int i) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (i < 9) {
				...
				if (i >= 18 && i < 27 ? !mergeItemStack(itemstack1, 27, 63, true) : (sellable ? !mergeItemStack(itemstack1, 18, 27, false) : (i >= 27 && i < 54 ? !mergeItemStack(itemstack1, 54, 63, false) : i >= 54 && i < 63 && !mergeItemStack(itemstack1, 27, 54, false)))) {
					return null;
				}
			}
