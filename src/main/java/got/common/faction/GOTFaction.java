...
public enum GOTFaction {
	...
	WILDLING(0x006400, DimensionRegion.WESTEROS, new GOTMapRegion(615, 520, 200)), 
	NIGHT_WATCH(0x282728, DimensionRegion.WESTEROS, new GOTMapRegion(750, 670, 150)), 
	NORTH(0xfffffe, DimensionRegion.WESTEROS, new GOTMapRegion(670, 930, 400)), 
	IRONBORN(0x555555, DimensionRegion.WESTEROS, new GOTMapRegion(349, 1323, 129)), 
	WESTERLANDS(0x7c0a02, DimensionRegion.WESTEROS, new GOTMapRegion(485, 1540, 200)), 
	RIVERLANDS(0x005E58, DimensionRegion.WESTEROS, new GOTMapRegion(675, 1437, 215)), 
	...
	TARGARYEN(0x790C06, DimensionRegion.WESTEROS, new GOTMapRegion(771, 1631, 100)),
	...
	REACH(0x006400, DimensionRegion.WESTEROS, new GOTMapRegion(500, 1820, 293)), 
	DORNE(0xcc5500, DimensionRegion.WESTEROS, new GOTMapRegion(717, 2011, 300)), 
	BRAAVOS(0x7c0a02, DimensionRegion.ESSOS, new GOTMapRegion(1221, 1351, 137)), 
	VOLANTIS(0x672F81, DimensionRegion.ESSOS, new GOTMapRegion(1553, 1928, 210)), 
	PENTOS(0x593800, DimensionRegion.ESSOS, new GOTMapRegion(1234, 1566, 172)), 
	NORVOS(0x8E5B5E, DimensionRegion.ESSOS, new GOTMapRegion(1437, 1468, 201)), 
	LORATH(0x498874, DimensionRegion.ESSOS, new GOTMapRegion(1379, 1354, 119)), 
	QOHOR(0xBF8F00, DimensionRegion.ESSOS, new GOTMapRegion(1590, 1594, 214)), 
	LYS(0x43C182, DimensionRegion.ESSOS, new GOTMapRegion(1110, 1876, 52)), 
	MYR(0x175989, DimensionRegion.ESSOS, new GOTMapRegion(1325, 1797, 223)), 
	TYROSH(0x6678A4, DimensionRegion.ESSOS, new GOTMapRegion(1204, 2053, 65)), 
	GHISCAR(0xC1963A, DimensionRegion.ESSOS, new GOTMapRegion(2115, 2180, 347)), 
	QARTH(0x611e03, DimensionRegion.ESSOS, new GOTMapRegion(2526, 2700, 740)), 
	LHAZAR(0xB5AA46, DimensionRegion.ESSOS, new GOTMapRegion(2510, 1910, 175)), 
	DOTHRAKI(0x592804, DimensionRegion.ESSOS, new GOTMapRegion(2270, 1670, 600)), 
	IBBEN(0x326322, DimensionRegion.ESSOS, new GOTMapRegion(2761, 1052, 252)), 
	JOGOS(0x592804, DimensionRegion.ESSOS, new GOTMapRegion(3369, 1651, 460)), 
	MOSSOVY(0x2B3F19, DimensionRegion.ESSOS, new GOTMapRegion(4056, 1480, 400)), 
	YI_TI(0xBF8F00, DimensionRegion.ESSOS, new GOTMapRegion(3350, 2200, 350)), 
	ASSHAI(0x282728, DimensionRegion.ESSOS, new GOTMapRegion(4098, 2331, 644)), 
	SOTHORYOS(0x164819, DimensionRegion.OTHER, new GOTMapRegion(2375, 3540, 1084)), 
	...
	public float getControlZoneAlignmentMultiplier(EntityPlayer entityplayer) {
		...
		double dist = distanceToNearestControlZoneInRange(entityplayer.posX, entityplayer.boundingBox.minY, entityplayer.posZ, reducedRange);
		if (dist >= 0.0) {
	...
	public boolean inDefinedControlZone(World world, double d, double d1, double d2, int extraMapRange) {
		if (world.provider instanceof GOTWorldProvider && ((GOTWorldProvider) world.provider).getGOTDimension() == factionDimension) {
	...
	public static void onInit() {
		...
		GOTFactionRelations.setRelations(MOSSOVY, ASSHAI, GOTFactionRelations.Relation.ENEMY);
		GOTFactionRelations.setRelations(MOSSOVY, IBBEN, GOTFactionRelations.Relation.FRIEND);
		GOTFactionRelations.setRelations(MOSSOVY, YI_TI, GOTFactionRelations.Relation.FRIEND);
		...
		ASSHAI.addControlZone(new GOTControlZone(4098, 2331, 644));
		...
		JOGOS.addControlZone(new GOTControlZone(3369, 1651, 460));
		...
		LYS.isViolent = false;
		MOSSOVY.addControlZone(new GOTControlZone(3972, 1659, 430));
		...
		YI_TI.addControlZone(new GOTControlZone(3050, 2554, 373));
		YI_TI.addControlZone(new GOTControlZone(3449, 2593, 222));
		YI_TI.addControlZone(new GOTControlZone(3482, 2178, 474));
