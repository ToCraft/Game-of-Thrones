...
public enum GOTDimension {
	GAME_OF_THRONES("GameOfThrones", 99, GOTWorldProvider.class, true, 99, EnumSet.of(DimensionRegion.ESSOS, DimensionRegion.WESTEROS, DimensionRegion.OTHER));
	...
	public static enum DimensionRegion {
		WESTEROS("westeros"), ESSOS("essos"), OTHER("other");
