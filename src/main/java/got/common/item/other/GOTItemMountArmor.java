...
public class GOTItemMountArmor extends Item {
	...
	public boolean isValid(GOTNPCMount mount) {
		if (mount instanceof GOTEntityGiraffe) {
			return false;
		}
		if (mount instanceof GOTEntityDeer) {
			return false;
		}
		if (mount instanceof GOTEntityElephant) {
			return false;
		}
		if (mount instanceof GOTEntityMammoth) {
			return false;
		}
		if (mount instanceof GOTEntityCamel) {
			return false;
		}
		if (mount instanceof GOTEntityRhino) {
			return mountType == Mount.RHINO;
		}
		if (mount instanceof GOTEntityWoolyRhino) {
			return mountType == Mount.RHINO;
		}
