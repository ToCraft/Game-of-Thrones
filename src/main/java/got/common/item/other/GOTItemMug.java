...
public class GOTItemMug extends Item {
	public static String[] strengthNames = new String[] { "weak", "light", "moderate", "strong", "potent" };
	public static float[] strengths = new float[] { 0.25f, 0.5f, 1.0f, 2.0f, 3.0f };
	public static float[] foodStrengths = new float[] { 0.5f, 0.75f, 1.0f, 1.25f, 1.5f };
