...
public class GOTEntityWight extends GOTEntityHumanBase {
	public static ItemStack[] militiaWeapons = new ItemStack[] { new ItemStack(GOTRegistry.westerosSword), new ItemStack(GOTRegistry.westerosHammer), new ItemStack(GOTRegistry.westerosPike), new ItemStack(Items.iron_sword), new ItemStack(Items.iron_axe), new ItemStack(GOTRegistry.ironBattleaxe), new ItemStack(GOTRegistry.ironPike), new ItemStack(GOTRegistry.bronzeSword), new ItemStack(GOTRegistry.bronzeAxe), new ItemStack(GOTRegistry.bronzeBattleaxe) };
	...
	public boolean attackEntityFrom(DamageSource damagesource, float f) {
		...
		if (entity instanceof EntityLivingBase && entity == damagesource.getSourceOfDamage() && (itemstack = ((EntityLivingBase) entity).getHeldItem()) != null && ((EntityLivingBase) entity).getHeldItem().getItem() instanceof GOTPotentialValyrianItem && (((GOTPotentialValyrianItem) itemstack.getItem()).getMaterial() == GOTMaterial.VALYRIAN || ((GOTPotentialValyrianItem) itemstack.getItem()).getMaterial() == GOTMaterial.SOTHORYOS || (GOTPotentialValyrianItem) itemstack.getItem() == GOTRegistry.crowbar)) {
			return super.attackEntityFrom(damagesource, f);
		} else if (damagesource.getEntity() instanceof GOTEntityGregorClegane || damagesource.getEntity() instanceof GOTEntityAsshaiArchmag || damagesource.isFireDamage()) {
			return super.attackEntityFrom(damagesource, f);
		}
