...
public class GOTEntityWhiteWalker extends GOTEntityNPC {
	public static ItemStack[] weapons = new ItemStack[] { new ItemStack(GOTRegistry.iceSword), new ItemStack(GOTRegistry.iceHeavySword) };
	...
	public boolean attackEntityFrom(DamageSource damagesource, float f) {
		...
		} else if (damagesource.getEntity() instanceof GOTEntityGregorClegane || damagesource.getEntity() instanceof GOTEntityAsshaiArchmag) {
			return super.attackEntityFrom(damagesource, f);
		}
	...
	public void dropFewItems(boolean flag, int i) {
		if(rand.nextInt(1000) == 0) {
			dropItem(GOTRegistry.whiteWalkersHoe, 1);
		}
