...
public class GOTEntityTargaryenLumberman extends GOTEntityTargaryenMarketTrader {
	public GOTEntityTargaryenLumberman(World world) {
		super(world);
		canBeMarried = false;
	}
	...
	public GOTTradeEntries getSellPool() {
		return GOTTradeEntries.WESTEROS_LUMBERMAN_SELL;
	}
