...
public class GOTEntityTargaryenLevyman extends GOTEntityTargaryenMan {
	...
	public GOTEntityTargaryenLevyman(World world) {
		super(world);
		canBeMarried = false;
		addTargetTasks(true);
	}
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			if (hiredNPCInfo.getHiringPlayer() == entityplayer) {
				return "westeros/targaryen/soldier/hired";
			}
			return "westeros/targaryen/soldier/friendly";
		}
		return "westeros/targaryen/soldier/hostile";
	}
