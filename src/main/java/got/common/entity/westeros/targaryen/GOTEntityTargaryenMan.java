...
import got.common.world.biome.westeros.GOTBiomeTargaryen;
...
public class GOTEntityTargaryenMan extends GOTEntityHumanBase implements IPickpocketable {
	...
	public GOTEntityTargaryenMan(World world) {
		...
		tasks.addTask(2, createTargaryenAttackAI());
	...
	public float getBlockPathWeight(int i, int j, int k) {
		...
		if (biome instanceof GOTBiomeTargaryen) {
			f += 20.0f;
		}
		return f;
	}
