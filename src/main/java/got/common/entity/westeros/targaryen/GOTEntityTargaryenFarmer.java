...
public class GOTEntityTargaryenFarmer extends GOTEntityTargaryenMan implements GOTTradeable, GOTUnitTradeable {
	public GOTEntityTargaryenFarmer(World world) {
		super(world);
		canBeMarried = false;
	...
	public String getSpeechBank(EntityPlayer entityplayer) {
		if (isFriendly(entityplayer)) {
			return "westeros/targaryen/farmer/friendly";
		}
		return "westeros/targaryen/farmer/hostile";
	}

	@Override
	public GOTUnitTradeEntries getUnits() {
		return GOTUnitTradeEntries.TARGARYEN_FARMER;
	}
