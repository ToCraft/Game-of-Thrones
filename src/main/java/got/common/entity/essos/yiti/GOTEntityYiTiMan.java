...
public class GOTEntityYiTiMan extends GOTEntityHumanBase implements IPickpocketable {
	public static ItemStack[] weapons = new ItemStack[] { new ItemStack(GOTRegistry.yitiDagger), new ItemStack(GOTRegistry.ironDagger), new ItemStack(GOTRegistry.bronzeDagger) };
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        ...
        if (this.familyInfo.isMale() && this.rand.nextInt(3000) == 0) {
            this.familyInfo.setName("Roobimwbj");
        }
        if (this.familyInfo.isMale() && this.rand.nextInt(3000) == 0) {
            this.familyInfo.setName("Mores");
        }
        if (this.familyInfo.isMale() && this.rand.nextInt(3000) == 0) {
            this.familyInfo.setName("12121");
        }
		return data;
	}
