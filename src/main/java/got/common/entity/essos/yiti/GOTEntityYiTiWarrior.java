...
public class GOTEntityYiTiWarrior extends GOTEntityYiTiLevyman {
	public GOTEntityYiTiWarrior(World world) {
		super(world);
		canBeMarried = false;
		addTargetTasks(true);
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		case 7:
			...
			break;
		case 8:
			npcItemsInv.setMeleeWeapon(new ItemStack(GOTRegistry.yitiDaggerPoisoned));
			break;
		case 9:
