...
public class GOTEntityYiTiLevyman extends GOTEntityYiTiMan {
	public static ItemStack[] levyWeapons = new ItemStack[] { new ItemStack(GOTRegistry.yitiDagger), new ItemStack(GOTRegistry.yitiDaggerPoisoned), new ItemStack(GOTRegistry.ironDagger), new ItemStack(GOTRegistry.bronzeDagger), new ItemStack(GOTRegistry.yitiBattleaxe), new ItemStack(Items.iron_sword), new ItemStack(GOTRegistry.bronzeSword), new ItemStack(GOTRegistry.ironBattleaxe), new ItemStack(GOTRegistry.bronzeBattleaxe), new ItemStack(GOTRegistry.yitiSpear), new ItemStack(GOTRegistry.ironSpear), new ItemStack(GOTRegistry.bronzeSpear) };
	public static ItemStack[] levySpears = new ItemStack[] { new ItemStack(GOTRegistry.yitiSpear), new ItemStack(GOTRegistry.ironSpear), new ItemStack(GOTRegistry.bronzeSpear) };
	public static ItemStack[] levyBodies = new ItemStack[] { new ItemStack(Items.leather_chestplate), new ItemStack(GOTRegistry.bronzeChestplate) };
	public static ItemStack[] levyLegs = new ItemStack[] { new ItemStack(Items.leather_leggings), new ItemStack(GOTRegistry.bronzeLeggings) };
	public static ItemStack[] levyBoots = new ItemStack[] { new ItemStack(Items.leather_boots), new ItemStack(GOTRegistry.bronzeBoots) };
	public static int[] kaftanColors = new int[] { 14823729, 11862016, 5512477, 14196753, 11374145, 7366222 };
