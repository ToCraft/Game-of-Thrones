...
public class GOTEntityIbbenMan extends GOTEntityHumanBase implements IPickpocketable {
	public static ItemStack[] weapons = new ItemStack[] { new ItemStack(GOTRegistry.ironDagger), new ItemStack(GOTRegistry.flintDagger), new ItemStack(Items.iron_axe), new ItemStack(Items.stone_axe), new ItemStack(GOTRegistry.ironBattleaxe) };
