...
public class GOTEntityDragon extends GOTEntityFlyingTameable {
	...
	public static String[] DATAWATCHER_WATCHEDOBJECTS = new String[] { "watchedObjects", "field_75695_b" };
	public static String[] ENTITYAITASKS_EXECUTINGTASKENTRIES = new String[] { "executingTaskEntries", "field_75780_b" };
	public static String[] ENTITYLIVING_BODYHELPER = new String[] { "bodyHelper", "field_70762_j" };
	public static String[] GUIMAINMENU_SPLASHTEXT = new String[] { "splashText", "field_73975_c" };
