...
public class GOTEntitySummerWarrior extends GOTEntitySummerMan {
	public static ItemStack[] weaponsBronze = new ItemStack[] { new ItemStack(GOTRegistry.summerSword), new ItemStack(GOTRegistry.summerSword), new ItemStack(GOTRegistry.summerSword), new ItemStack(GOTRegistry.summerDagger), new ItemStack(GOTRegistry.summerDaggerPoisoned), new ItemStack(GOTRegistry.summerPike) };
