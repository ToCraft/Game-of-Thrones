...
public abstract class GOTEntityScorpion extends EntityMob implements GOTMobSpawnerCondition {
	public float scorpionWidth = -1.0f;
	public float scorpionHeight;
	public boolean spawningFromSpawner = false;

	public GOTEntityScorpion(World world) {
		super(world);
		setSize(1.2f, 0.9f);
		getNavigator().setAvoidsWater(true);
		tasks.addTask(0, new EntityAISwimming(this));
		tasks.addTask(1, new GOTEntityAIAttackOnCollide(this, 1.2, false));
