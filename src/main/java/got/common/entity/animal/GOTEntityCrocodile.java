...
public class GOTEntityCrocodile extends EntityMob {
	...
	public GOTEntityCrocodile(World world) {
		...
		targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, GOTEntityNPC.class, 400, true));
	}
	...
	public boolean isValidLightLevel() {
		...
		if (worldObj.getBiomeGenForCoords(i, MathHelper.floor_double(posZ)) instanceof GOTBiomeSothoryosMangrove) {
			return true;
		}
