...
public class GOTEventSpawner {
	...
	public static List<GOTTravellingTraderSpawner> travellingTraders = new ArrayList<>();
	...
	public static void createTraderSpawner(Class entityClass) {
		if (!traderClasses.contains(entityClass)) {
			...
			travellingTraders.add(new GOTTravellingTraderSpawner(entityClass));
		}
	}

	public static void performSpawning(World world) {
		for (GOTTravellingTraderSpawner trader : travellingTraders) {
