...
public abstract class GOTBiome extends BiomeGenBase {
	...
	public static GOTBiome blackIslandsTargaryen;
	public static GOTBiome blackIslandsFlatTargaryen;
	...
	public static GOTBiome crownlandsTargaryen;
	public static GOTBiome crownlandsFlatTargaryen;
	public static GOTBiome crownlandsForestTargaryen;
	public static GOTBiome crownlandsTownTargaryen;
	...
	public static GOTBiome dragonstoneTargaryen;
	public static GOTBiome dragonstoneFlatTargaryen;
	...
	public static GOTBiome massyFlatTargaryen;
	...
	public static GOTBiome mossovyTundra;
	...
	public int getBiomeFoliageColor(int i, int j, int k) {
		int folgColor = biomeColors.foliage != null ? biomeColors.foliage.getRGB() : getBaseFoliageColor(i, j, k);
		return folgColor;
	}
	...
	public int getBiomeGrassColor(int i, int j, int k) {
		int grassColor = biomeColors.grass != null ? biomeColors.grass.getRGB() : getBaseGrassColor(i, j, k);
		return grassColor;
	}
	...
	public void registerEssosFlowers() {
		flowers.clear();
	...
	public void registerTravellingTrader(Class entityClass) {
		...
		GOTEventSpawner.createTraderSpawner(entityClass);
	}
	...
	public static void performSeasonChanges(World world) {
		for (GOTBiome biome : GOTDimension.GAME_OF_THRONES.biomeList) {
			...
			case WINTER:
				if (biome.isAlwaysWinter) {
	    			biome.setTemperatureRainfall(0.0F, 0.8F);
				...
				if (biome.isLongWinter || biome.isSeasonalWinter) {
	    			biome.setTemperatureRainfall(0.0F, 0.8F);
	    			biome.biomeColors.setGrass(0xffffff);
	    			biome.biomeColors.setFoggy(true);
	    			biome.biomeColors.setSky(4212300);
			...
			case SPRING:
				...
				if (biome.isLongWinter || biome.isSeasonalWinter) {
	    			biome.setTemperatureRainfall(0.28F, 0.9F);
	    			biome.biomeColors.resetGrass();
			...
			case SUMMER:
				...
				if (biome.isNeverWinter) {
	    			biome.setTemperatureRainfall(1.2F, 0.6F);
	...
	public static void preInit() {
		...
		arrynForest = new GOTBiomeArrynMountainsFoothills(id++, true).setIsSeasonalWinter().setMinMaxHeight(0.7f, 0.9f).setColor(0x587F3F).setBiomeName("arrynForest");
		arrynMountains = new GOTBiomeArrynMountains(id++, true).setIsLongWinter().setMinMaxHeight(2.0f, 2.0f).setColor(0xC5D3D6).setBiomeName("arrynMountains");
		...
		blackIslandsTargaryen = new GOTBiomeTargaryen(id++, true).setIsSeasonalWinter().setMinMaxHeight(0.3f, 0.35f).setColor(0x78A246).setBiomeName("blackIslands");
		blackIslandsFlatTargaryen = new GOTBiomeTargaryenFlat(id++, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x78A346).setBiomeName("blackIslands");
		boneMountains = new GOTBiomeBoneMountains(id++, true).setIsLongWinter().setMinMaxHeight(2.0f, 2.0f).setColor(0xE2E2E2).setBiomeName("boneMountains");
		...
		crownlandsTargaryen = new GOTBiomeTargaryen(id++, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.15f).setColor(0x789F46).setBiomeName("crownlands");
		crownlandsFlatTargaryen = new GOTBiomeTargaryenFlat(id++, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x78A046).setBiomeName("crownlands");
		crownlandsForestTargaryen = new GOTBiomeTargaryenForest(id++, true).setIsNeverWinter().setMinMaxHeight(0.1f, 0.15f).setColor(0x70991E).setBiomeName("crownlandsForest");
		crownlandsTownTargaryen = new GOTBiomeTargaryenTown(id++, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x789E46).setBiomeName("crownlandsTown");
		...
		dorneMountains = new GOTBiomeDorneMountains(id++, true).setIsLongWinter().setMinMaxHeight(2.0f, 2.0f).setColor(0xD6C9CC).setBiomeName("dorneMountains");
		...
		dragonstoneTargaryen = new GOTBiomeTargaryen(id++, true).setIsSeasonalWinter().setMinMaxHeight(0.3f, 0.35f).setColor(0x78A446).setBiomeName("dragonstone");
		dragonstoneFlatTargaryen = new GOTBiomeTargaryenFlat(id++, true).setIsSeasonalWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x78A546).setBiomeName("dragonstone");
		...
		essosHills = new GOTBiomeFreeCities(id++, true).setIsNeverWinter().setMinMaxHeight(0.1f, 1f).setColor(0x7B843A).setBiomeName("essosHills");;
		essosMountains = new GOTBiomeEssosMountains(id++, true).setIsLongWinter().setMinMaxHeight(2.0f, 2.0f).setColor(0x808080).setBiomeName("essosMountains");
		...
		massyFlatTargaryen = new GOTBiomeTargaryenFlat(id++, true).setIsNeverWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x78A146).setBiomeName("massy");
		...
		mossovyMarshes = new GOTBiomeMossovyMarshes(id++, true).setIsLongWinter().setMinMaxHeight(-0.05f, 0.05f).setColor(0x677F43).setBiomeName("mossovyMarshes");
		...
		mossovyTundra = new GOTBiomeMossovyTundra(id++, true).setIsLongWinter().setMinMaxHeight(0.1f, 0.15f).setColor(0x6A824F).setBiomeName("mossovyTundra");
		...
		neck = new GOTBiomeNeck(id++, true).setIsLongWinter().setMinMaxHeight(-0.05f, 0.05f).setColor(0x578C54).setBiomeName("neck");
		...
		northMountains = new GOTBiomeNorthMountains(id++, true).setIsLongWinter().setMinMaxHeight(2.0f, 2.0f).setColor(0xD8D8D8).setBiomeName("northMountains");
		...
		shadowLand = new GOTBiomeShadowLand(id++, true).setMinMaxHeight(0.1f, 0.15f).setTemperatureRainfall(0.8F, 0.8F).setColor(0x8E8854).setBiomeName("shadowLand");
		shadowMountains = new GOTBiomeShadowMountains(id++, true).setMinMaxHeight(2.0f, 2.0f).setTemperatureRainfall(0.8F, 0.8F).setColor(0x635E3B).setBiomeName("shadowMountains");
		shadowTown = new GOTBiomeShadowTown(id++, true).setMinMaxHeight(0.1f, 0.0f).setTemperatureRainfall(0.8F, 0.8F).setColor(0x8C8340).setBiomeName("shadowTown");
		shadowWasteland = new GOTBiomeShadowWasteland(id++, true).setMinMaxHeight(0.1f, 0.0f).setTemperatureRainfall(0.8F, 0.8F).setColor(0xA39E60).setBiomeName("shadowWasteland");
		...
		sothoryosMangrove = new GOTBiomeSothoryosMangrove(id++, true).setIsNeverWinter().setMinMaxHeight(-0.05f, 0.05f).setColor(0x737f42).setBiomeName("sothoryosMangrove");
		sothoryosMountains = new GOTBiomeSothoryosMountains(id++, true).setIsLongWinter().setMinMaxHeight(2.0f, 2.0f).setColor(0x665C48).setBiomeName("sothoryosMountains");
		...
		stepstones = new GOTBiomeStepstones(id++, true).setIsNeverWinter().setMinMaxHeight(0.1f, 0.15f).setColor(0x9BA37A).setBiomeName("stepstones");
		...
		ulthosMountains = new GOTBiomeUlthosMountains(id++, true).setIsLongWinter().setMinMaxHeight(2.0f, 2.0f).setColor(0x222618).setBiomeName("ulthosMountains");
		...
		valyriaSea = new GOTBiomeValyriaSea(id++, true).setMinMaxHeight(-1.0f, 0.0f).setTemperatureRainfall(1.2F, 0.8F).setColor(0x0D304C).setBiomeName("valyriaSea");
		...
		volantisMarshes = new GOTBiomeVolantisMarshes(id++, true).setIsNeverWinter().setMinMaxHeight(-0.05f, 0.05f).setColor(0x89933e).setBiomeName("volantisMarshes");
		...
		wetwood = new GOTBiomeWetwood(id++, true).setIsSeasonalWinter().setMinMaxHeight(-0.05f, 0.05f).setColor(0x599958).setBiomeName("wetwood");
		...
		ibbenMountains = new GOTBiomeIbbenMountains(id++, true).setIsLongWinter().setMinMaxHeight(2.0f, 2.0f).setColor(0x808081).setBiomeName("ibbenMountains");
		ibben = new GOTBiomeIbbenFlat(id++, true).setIsLongWinter().setMinMaxHeight(0.1f, 0.0f).setColor(0x74B748).setBiomeName("ibben");
	}
