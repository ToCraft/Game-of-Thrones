...
public class GOTBiomeStoneCoast extends GOTBiomeWesteros {
	public GOTBiomeStoneCoast(int i, boolean major) {
		...
		container[0] = GOTBiomeSpawnList.entry(GOTSpawnList.NORTH_CONQUEST, 10).setSpawnChance(1000);
		npcSpawnList.newFactionList(100).add(container);

		SpawnListContainer[] container2 = new SpawnListContainer[1];
		container2[0] = GOTBiomeSpawnList.entry(GOTSpawnList.IRONBORN_CONQUEST, 10).setSpawnChance(1000);
