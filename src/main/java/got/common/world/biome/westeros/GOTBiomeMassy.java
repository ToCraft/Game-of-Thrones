...
public class GOTBiomeMassy extends GOTBiomeDragonstone {
	...
	public WorldGenerator boulderGenMassy = new GOTWorldGenBoulder(GOTRegistry.rock, 1, 1, 4);
	...
	public GOTBiomeMassy(int i, boolean major) {
		...
		decorator.addTree(GOTTreeType.BIRCH, 200);
	...
	public void decorate(World world, Random random, int i, int k) {
		...
		if (random.nextInt(5) == 0) {
			for (int l = 0; l < 4; ++l) {
				...
				boulderGenMassy.generate(world, random, i1, world.getHeightValue(i1, k1), k1);
			}
		}
	}
