...
public class GOTBiomeFrostfangs extends GOTBiome {
	...
	public void decorate(World world, Random random, int i, int k) {
		...
		if (GOTSpawner.ThreeEyedRaven.generatesAt(world, i, k)) {
			new GOTSpawner.ThreeEyedRaven(false).generateWithSetRotation(world, random, i, world.getTopSolidOrLiquidBlock(i, k), k, 0);
		}
	}
