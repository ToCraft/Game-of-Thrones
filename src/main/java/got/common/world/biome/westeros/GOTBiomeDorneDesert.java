...
import got.common.world.structure.westeros.dorne.GOTWaypointDorneCastle;
...
public class GOTBiomeDorneDesert extends GOTBiome {
	...
	public GOTBiomeDorneDesert(int i, boolean major) {
		...
		spawnableMonsterList.add(new BiomeGenBase.SpawnListEntry(GOTEntityDesertScorpion.class, 10, 4, 4));
	...
	public void decorate(World world, Random random, int i, int k) {
		...
		if (GOTSpawner.QuentynQorgyle.generatesAt(world, i, k)) {
			new GOTSpawner.QuentynQorgyle(false).generateWithSetRotation(world, random, i, world.getTopSolidOrLiquidBlock(i, k), k, 0);
		}
	}
