...
import got.common.world.structure.essos.legendary.GOTStructureEuronShip;
...
public class GOTBiomeOcean extends GOTBiome {
	...
	public void decorate(World world, Random random, int i, int k) {
		...
		if (GOTStructureEuronShip.generatesAt(world, i, k)) {
			new GOTStructureEuronShip(false).generateWithSetRotation(world, random, i, 54, k, 0);
		}
		if (k > -30000) {
