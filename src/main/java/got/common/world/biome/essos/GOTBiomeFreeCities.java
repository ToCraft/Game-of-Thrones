...
public class GOTBiomeFreeCities extends GOTBiome {
	...
	public GOTBiomeFreeCities(int i, boolean major) {
		super(i, major);
	...
	public void decorate(World world, Random random, int i, int k) {
		...
		if (GOTSpawner.Mellario.generatesAt(world, i, k)) {
			new GOTSpawner.Mellario(false).generateWithSetRotation(world, random, i, world.getTopSolidOrLiquidBlock(i, k), k, 0);
		}
		if (GOTSpawner.SalladhorSaan.generatesAt(world, i, k)) {
			new GOTSpawner.SalladhorSaan(false).generateWithSetRotation(world, random, i, world.getTopSolidOrLiquidBlock(i, k), k, 0);
		}
		if (GOTSpawner.TychoNestoris.generatesAt(world, i, k)) {
			new GOTSpawner.TychoNestoris(false).generateWithSetRotation(world, random, i, world.getTopSolidOrLiquidBlock(i, k), k, 0);
		}
	}
