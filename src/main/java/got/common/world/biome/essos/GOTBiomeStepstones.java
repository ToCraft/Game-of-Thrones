...
public class GOTBiomeStepstones extends GOTBiome {
	...
	public GOTBiomeStepstones(int i, boolean major) {
		...
		container0[0] = GOTBiomeSpawnList.entry(GOTSpawnList.GHISCAR_CORSAIR, 10).setSpawnChance(200);
		...
		decorator.addRandomStructure(new GOTStructureGhiscarCamp(false), 50);
	}
