...
import got.common.world.structure.essos.braavos.GOTWaypointBraavosTown;
...
public class GOTBiomeBraavosFlat extends GOTBiomeBraavos {
	public GOTBiomeBraavosFlat(int i, boolean major) {
		...
		container0[0] = GOTBiomeSpawnList.entry(GOTSpawnList.BRAAVOS_CIVILIAN, 10).setSpawnChance(500);
		container0[1] = GOTBiomeSpawnList.entry(GOTSpawnList.BRAAVOS_MILITARY, 4).setSpawnChance(500);
		...
		container2[0] = GOTBiomeSpawnList.entry(GOTSpawnList.PENTOS_MILITARY, 10);
		...
		GOTWaypointBraavosTown town = new GOTWaypointBraavosTown(this, 0.0f);
