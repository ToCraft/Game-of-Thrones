...
public class GOTBiomeIbbenColony extends GOTBiomeEssos {
	public GOTBiomeIbbenColony(int i, boolean major) {
		...
		container[0] = GOTBiomeSpawnList.entry(GOTSpawnList.IBBEN_CIVILIAN, 2).setSpawnChance(500);
		npcSpawnList.newFactionList(100).add(container);

        SpawnListContainer[] containerLSR = new SpawnListContainer[1];
        containerLSR[0] = GOTBiomeSpawnList.entry(GOTSpawnList.UNRELIABLE, 2).setSpawnChance(500);
