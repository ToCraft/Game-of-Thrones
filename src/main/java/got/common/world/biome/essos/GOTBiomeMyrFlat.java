...
import got.common.world.structure.essos.myr.GOTWaypointMyrTown;
...
public class GOTBiomeMyrFlat extends GOTBiomeMyr {
	public GOTBiomeMyrFlat(int i, boolean major) {
		...
		container0[0] = GOTBiomeSpawnList.entry(GOTSpawnList.MYR_CIVILIAN, 10).setSpawnChance(500);
		container0[1] = GOTBiomeSpawnList.entry(GOTSpawnList.MYR_MILITARY, 4).setSpawnChance(500);
		...
		container2[0] = GOTBiomeSpawnList.entry(GOTSpawnList.TYROSH_MILITARY, 10);
		...
		GOTWaypointMyrTown town = new GOTWaypointMyrTown(this, 0.0f);
