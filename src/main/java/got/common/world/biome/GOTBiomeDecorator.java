...
public class GOTBiomeDecorator {
	...
	public void addDefaultOres() {
		...
		addOre(new WorldGenMinable(GOTRegistry.oreSilver, 8), 5.0f, 0, 32);
	...
	public void decorate() {
        ...
        {
            i4 = this.chunkX + rand.nextInt(16) + 8;
            k2 = this.chunkZ + rand.nextInt(16) + 8;
		...
		if (rand.nextInt(2) == 0) {
			...
			j3 = rand.nextInt(128);
			k6 = chunkZ + rand.nextInt(16) + 8;
			new WorldGenFlowers(GOTRegistry.plantain).generate(worldObj, rand, i, j3, k6);
			new WorldGenFlowers(GOTRegistry.pipeweedPlant).generate(worldObj, rand, i, j3, k6);
		}
