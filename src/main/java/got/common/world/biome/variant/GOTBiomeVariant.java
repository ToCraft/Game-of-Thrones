...
public class GOTBiomeVariant {
	...
	public static GOTBiomeVariant[] SET_SWAMP = new GOTBiomeVariant[] { SWAMP_LOWLAND, SWAMP_LOWLAND, SWAMP_LOWLAND, SWAMP_UPLAND };
	public static GOTBiomeVariant[] SET_MOUNTAINS = new GOTBiomeVariant[] { FOREST, FOREST_LIGHT };
