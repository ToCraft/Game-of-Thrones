...
public enum GOTFixedStructures {
	...
	public static boolean generatesAtMapImageCoords(int i, int k, GOTWaypoint waypoint) {
		int x = GOTWaypoint.mapToWorldX(waypoint.imgX);
		int z = GOTWaypoint.mapToWorldZ(waypoint.imgY);
		return GOTFixedStructures.generatesAt(i, k, x, z);
	}

	public static boolean generatesAtMapImageCoords(int i, int k, GOTWaypoint waypoint, int a, int b) {
