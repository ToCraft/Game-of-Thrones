...
public enum GOTWaypoint implements GOTAbstractWaypoint {
	...
	public static enum Region {
		TARGARYEN, ABOBA, NORTH, ARRYN, ICE, RIVERLANDS, MOSSOVY, DRANGONSTONE, CROWNLANDS, DORNE, DOTHRAKI, IBBEN, IRONBORN, LHAZAR, REACH, OCEAN, STORMLANDS, WESTERLANDS, ASSHAI, GHISCAR, JOGOS, VALYRIA, FREE, QARTH, SOTHORYOS, ULTHOS, YITI;
