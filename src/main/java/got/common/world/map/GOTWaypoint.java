...
public enum GOTWaypoint implements GOTAbstractWaypoint {
	...
	public static enum Region {
		NORTH, ARRYN, ICE, RIVERLANDS, MOSSOVY, DRANGONSTONE, TARGARYEN, CROWNLANDS, DORNE, DOTHRAKI, IBBEN, IRONBORN, LHAZAR, REACH, OCEAN, STORMLANDS, WESTERLANDS, ASSHAI, GHISCAR, JOGOS, VALYRIA, FREE, QARTH, SOTHORYOS, ULTHOS, YITI;
