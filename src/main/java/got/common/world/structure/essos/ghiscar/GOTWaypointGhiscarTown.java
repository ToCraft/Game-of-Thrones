...
public class GOTWaypointGhiscarTown extends GOTVillageGen {
	public GOTWaypointGhiscarTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointGhiscarTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityGhiscarLevyman.class, GOTEntityGhiscarArcher.class);
		}
