...
public abstract class GOTStructureLhazarBase extends GOTStructureBase {
	...
	public ItemStack getRandomlhazarWeapon(Random random) {
		ItemStack[] items = new ItemStack[] { new ItemStack(GOTRegistry.lhazarSword), new ItemStack(GOTRegistry.lhazarSword), new ItemStack(GOTRegistry.lhazarDagger), new ItemStack(GOTRegistry.lhazarSpear), new ItemStack(GOTRegistry.lhazarClub) };
