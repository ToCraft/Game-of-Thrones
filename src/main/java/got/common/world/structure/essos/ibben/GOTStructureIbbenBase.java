...
public abstract class GOTStructureIbbenBase extends GOTStructureBase {
	...
	public ItemStack getRandomWeapon(Random random) {
		ItemStack[] items = new ItemStack[] { new ItemStack(GOTRegistry.stoneSpear), new ItemStack(GOTRegistry.ironSpear), new ItemStack(GOTRegistry.ironDagger), new ItemStack(GOTRegistry.ironDaggerPoisoned) };
