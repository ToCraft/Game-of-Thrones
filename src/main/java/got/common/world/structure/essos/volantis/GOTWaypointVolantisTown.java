...
public class GOTWaypointVolantisTown extends GOTVillageGen {
	public GOTWaypointVolantisTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointVolantisTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityVolantisWarrior.class, GOTEntityVolantisArcher.class);
		}
