...
public class GOTWaypointQarthTown extends GOTVillageGen {
	public GOTWaypointQarthTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointQarthTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void addVillageStructures(Random random) {
			...
			this.addStructure(new GOTStructureNPCRespawner(false) {
				...
				public void setupRespawner(GOTEntityNPCRespawner spawner) {
					spawner.setSpawnClass(GOTEntityQarthWarlord.class);
					spawner.setCheckRanges(80, -12, 12, 2);
					spawner.setSpawnRanges(60, -6, 6, 64);
					spawner.setSpawnInterval(1);
					spawner.setNoPlayerRange(1);
				}
			}, 0, 0, 0);
			this.addStructure(new GOTStructureNPCRespawner(false) {
			...
			this.addStructure(new GOTStructureNPCRespawner(false) {
				...
				@Override
				public void setupRespawner(GOTEntityNPCRespawner spawner) {
					Instance.this.setWarlockSpawnClass(spawner);
		...
		public void setWarlockSpawnClass(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClass(GOTEntityQarthWarlock.class);
		}

		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityQarthWarrior.class, GOTEntityQarthArcher.class);
		}
