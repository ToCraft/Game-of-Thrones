...
public class GOTStructureLhazarBazaar extends GOTStructureLhazarBase {
	public static Class[] stalls = new Class[] { Mason.class, Butcher.class, Brewer.class, Fish.class, Baker.class, Miner.class, Goldsmith.class, Lumber.class, Hunter.class, Blacksmith.class, Farmer.class };
