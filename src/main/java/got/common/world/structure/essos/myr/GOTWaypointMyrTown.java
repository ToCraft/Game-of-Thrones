...
public class GOTWaypointMyrTown extends GOTVillageGen {
	public GOTWaypointMyrTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointMyrTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityMyrWarrior.class, GOTEntityMyrArcher.class);
		}
