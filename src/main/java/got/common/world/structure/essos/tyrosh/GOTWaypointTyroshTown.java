...
public class GOTWaypointTyroshTown extends GOTVillageGen {
	public GOTWaypointTyroshTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointTyroshTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void addVillageStructures(Random random) {
			...
			this.addStructure(new GOTStructureNPCRespawner(false) {
				...
				public void setupRespawner(GOTEntityNPCRespawner spawner) {
					spawner.setSpawnClass(GOTEntityTyroshWarlord.class);
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityTyroshWarrior.class, GOTEntityTyroshArcher.class);
		}
