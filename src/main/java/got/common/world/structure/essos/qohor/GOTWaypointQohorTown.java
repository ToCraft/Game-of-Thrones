...
public class GOTWaypointQohorTown extends GOTVillageGen {
	public GOTWaypointQohorTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointQohorTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityQohorUnsullied.class, GOTEntityQohorArcher.class);
		}
