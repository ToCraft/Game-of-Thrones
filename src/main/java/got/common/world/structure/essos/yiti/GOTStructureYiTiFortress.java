...
public class GOTStructureYiTiFortress extends GOTStructureYiTiBaseTown {
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < soldiers; ++l) {
			GOTEntityYiTiWarrior soldier;
			soldier = random.nextInt(3) == 0 ? new GOTEntityYiTiArcher(world) : new GOTEntityYiTiWarrior(world);
			if (random.nextInt(3) == 0) {
		...
		respawner.setSpawnClasses(GOTEntityYiTiWarrior.class, GOTEntityYiTiArcher.class);
