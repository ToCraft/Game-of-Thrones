...
public abstract class GOTStructureIbbenMarketStall extends GOTStructureIbbenBase {
	public static Class[] allStallTypes = new Class[] { Blacksmith.class, Farmer.class, Lumber.class, Builder.class, Brewer.class, Butcher.class, Fish.class, Baker.class, Orcharder.class };
