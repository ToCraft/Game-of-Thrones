...
public class GOTWaypointPentosTown extends GOTVillageGen {
	public GOTWaypointPentosTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointPentosTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityPentosLevyman.class, GOTEntityPentosArcher.class);
		}
