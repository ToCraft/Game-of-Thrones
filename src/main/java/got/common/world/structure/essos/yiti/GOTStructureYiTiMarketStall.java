...
public abstract class GOTStructureYiTiMarketStall extends GOTStructureYiTiBase {
	public static Class[] allStallTypes = new Class[] { Blacksmith.class, Lumber.class, Mason.class, Butcher.class, Brewer.class, Fish.class, Baker.class, Hunter.class, Farmer.class, Gold.class };
