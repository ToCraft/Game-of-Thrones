...
public class GOTWaypointLysTown extends GOTVillageGen {
	public GOTWaypointLysTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointLysTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void addVillageStructures(Random random) {
			...
			this.addStructure(new GOTStructureNPCRespawner(false) {
				...
				public void setupRespawner(GOTEntityNPCRespawner spawner) {
					spawner.setSpawnClass(GOTEntityLysWarlord.class);
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityLysWarrior.class, GOTEntityLysArcher.class);
		}
