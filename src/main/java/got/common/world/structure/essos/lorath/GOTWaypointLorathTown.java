...
public class GOTWaypointLorathTown extends GOTVillageGen {
	public GOTWaypointLorathTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointLorathTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void addVillageStructures(Random random) {
			...
			this.addStructure(new GOTStructureNPCRespawner(false) {
				...
				public void setupRespawner(GOTEntityNPCRespawner spawner) {
					spawner.setSpawnClass(GOTEntityLorathWarlord.class);
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityLorathWarrior.class, GOTEntityLorathArcher.class);
		}
