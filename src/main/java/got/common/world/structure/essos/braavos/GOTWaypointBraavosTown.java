...
public class GOTWaypointBraavosTown extends GOTVillageGen {
	public GOTWaypointBraavosTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointBraavosTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void setWarriorSpawnClasses(GOTEntityNPCRespawner spawner) {
			spawner.setSpawnClasses(GOTEntityBraavosWarrior.class, GOTEntityBraavosArcher.class);
		}
