...
public class GOTStructureAsshaiFort extends GOTStructureAsshaiBase {
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityAsshaiArchmag legend = new GOTEntityAsshaiArchmag(world);
		spawnLegendaryNPC(legend, world, 0, 1, 0);
	...
	public ItemStack getRandomUrukWeapon(Random random) {
		ItemStack[] items = new ItemStack[] { new ItemStack(GOTRegistry.asshaiSword), new ItemStack(GOTRegistry.asshaiDagger), new ItemStack(GOTRegistry.asshaiDaggerPoisoned), new ItemStack(GOTRegistry.asshaiSpear), new ItemStack(GOTRegistry.asshaiBattleaxe), new ItemStack(GOTRegistry.asshaiHammer) };
