...
public class GOTStructureTargaryenTavern extends GOTStructureTargaryenBase {
	public String[] tavernName;
	public String[] tavernNameSign;

	public GOTStructureTargaryenTavern(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityTargaryenBartender bartender = new GOTEntityTargaryenBartender(world);
