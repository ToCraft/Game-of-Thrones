...
public class GOTWaypointStormlandsTown extends GOTVillageGen {
	public GOTWaypointStormlandsTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointStormlandsTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
