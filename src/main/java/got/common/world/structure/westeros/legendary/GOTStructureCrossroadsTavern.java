...
public class GOTStructureCrossroadsTavern extends GOTStructureRiverlandsBase {
	public String[] tavernName;
	public String[] tavernNameSign;

	public GOTStructureCrossroadsTavern(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		spawnLegendaryNPC(new GOTEntityHotPie(world), world, 1, 1, 7);
		spawnLegendaryNPC(new GOTEntityVargoHoat(world), world, 1, 1, 7);
		return true;
	}
	...
	public static boolean generatesAt(World world, int i, int k) {
		return GOTFixedStructures.generatesAtMapImageCoords(i, k, 735, 1439);
	}
}
