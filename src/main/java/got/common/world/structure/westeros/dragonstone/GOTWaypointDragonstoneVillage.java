...
public class GOTWaypointDragonstoneVillage extends GOTVillageGen {
	public GOTWaypointDragonstoneVillage(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointDragonstoneVillage village, World world, int i, int k, Random random, GOTLocationInfo loc) {
