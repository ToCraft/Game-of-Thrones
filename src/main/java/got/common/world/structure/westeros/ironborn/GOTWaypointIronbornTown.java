...
public class GOTWaypointIronbornTown extends GOTVillageGen {
	public GOTWaypointIronbornTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointIronbornTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
