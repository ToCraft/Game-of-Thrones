...
public class GOTWaypointReachCastle extends GOTVillageGen {
	public GOTWaypointReachCastle(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointReachCastle village, World world, int i, int k, Random random, GOTLocationInfo loc) {
