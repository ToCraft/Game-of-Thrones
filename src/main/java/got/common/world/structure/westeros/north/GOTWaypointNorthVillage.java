...
public class GOTWaypointNorthVillage extends GOTVillageGen {
	public GOTWaypointNorthVillage(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointNorthVillage village, World world, int i, int k, Random random, GOTLocationInfo loc) {
