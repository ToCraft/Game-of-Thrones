...
public class GOTWaypointRiverlandsTown extends GOTVillageGen {
	public GOTWaypointRiverlandsTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointRiverlandsTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
