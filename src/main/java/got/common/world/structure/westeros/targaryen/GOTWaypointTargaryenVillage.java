...
public class GOTWaypointTargaryenVillage extends GOTVillageGen {
	public GOTWaypointTargaryenVillage(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointTargaryenVillage village, World world, int i, int k, Random random, GOTLocationInfo loc) {
