...
public class GOTStructureTargaryenWatchtower extends GOTStructureTargaryenBase {
	public GOTStructureTargaryenWatchtower(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		respawner.setSpawnClass(GOTEntityTargaryenSoldier.class);
