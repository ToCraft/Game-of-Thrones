...
public class GOTStructureEastWatch extends GOTStructureGiftBase {
	public GOTStructureEastWatch(boolean flag) {
		super(flag);
	}
	...
	public static boolean generatesAt(World world, int i, int k) {
		return GOTFixedStructures.generatesAtMapImageCoords(i, k, 833, 635);
	}
}
