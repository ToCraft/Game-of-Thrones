...
public class GOTWaypointReachVillage extends GOTVillageGen {
	public GOTWaypointReachVillage(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointReachVillage village, World world, int i, int k, Random random, GOTLocationInfo loc) {
