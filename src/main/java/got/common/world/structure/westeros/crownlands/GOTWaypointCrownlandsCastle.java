...
public class GOTWaypointCrownlandsCastle extends GOTVillageGen {
	public GOTWaypointCrownlandsCastle(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointCrownlandsCastle village, World world, int i, int k, Random random, GOTLocationInfo loc) {
