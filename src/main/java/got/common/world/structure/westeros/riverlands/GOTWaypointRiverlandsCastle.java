...
public class GOTWaypointRiverlandsCastle extends GOTVillageGen {
	public GOTWaypointRiverlandsCastle(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointRiverlandsCastle village, World world, int i, int k, Random random, GOTLocationInfo loc) {
