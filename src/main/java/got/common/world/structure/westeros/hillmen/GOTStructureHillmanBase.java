...
public abstract class GOTStructureHillmanBase extends GOTStructureBase {
	...
	public ItemStack getRandomHillmanWeapon(Random random) {
		ItemStack[] items = new ItemStack[] { new ItemStack(Items.iron_sword), new ItemStack(GOTRegistry.ironSpear), new ItemStack(GOTRegistry.ironDagger), new ItemStack(Items.stone_sword), new ItemStack(GOTRegistry.stoneSpear), new ItemStack(GOTRegistry.club), new ItemStack(GOTRegistry.trident) };
		return items[random.nextInt(items.length)].copy();
	}

	public void placeHillmanItemFrame(World world, Random random, int i, int j, int k, int direction) {
		ItemStack[] items = new ItemStack[] { new ItemStack(Items.bone), new ItemStack(GOTRegistry.fur), new ItemStack(Items.flint), new ItemStack(Items.iron_sword), new ItemStack(Items.stone_sword), new ItemStack(GOTRegistry.ironSpear), new ItemStack(GOTRegistry.stoneSpear), new ItemStack(Items.bow), new ItemStack(Items.arrow), new ItemStack(GOTRegistry.mug), new ItemStack(GOTRegistry.skullCup) };
