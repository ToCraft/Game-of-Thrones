...
public class GOTStructureTargaryenBath extends GOTStructureTargaryenBase {
	public GOTStructureTargaryenBath(boolean flag) {
		super(flag);
	}

	public GOTEntityNPC createBather(World world) {
		return new GOTEntityTargaryenMan(world);
	}
