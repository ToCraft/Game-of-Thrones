...
public class GOTStructureTargaryenFortress extends GOTStructureTargaryenBase {
	public GOTStructureTargaryenFortress(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, -2, 4, -11, GOTItemBanner.BannerType.TARGARYEN, 2);
		placeWallBanner(world, 2, 4, -11, GOTItemBanner.BannerType.TARGARYEN, 2);
		for (i8 = -2; i8 <= 2; i8++) {
		...
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.TARGARYEN, 0);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.TARGARYEN, 1);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.TARGARYEN, 2);
		placeWallBanner(world, 0, 9, 0, GOTItemBanner.BannerType.TARGARYEN, 3);
		...
		placeWallBanner(world, -2, 3, 9, GOTItemBanner.BannerType.TARGARYEN, 2);
		placeWallBanner(world, 2, 3, 9, GOTItemBanner.BannerType.TARGARYEN, 2);
