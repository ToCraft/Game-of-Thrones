...
public class GOTWaypointDragonstoneTown extends GOTVillageGen {
	public GOTWaypointDragonstoneTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointDragonstoneTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
