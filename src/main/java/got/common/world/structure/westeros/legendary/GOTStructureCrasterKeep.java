...
public class GOTStructureCrasterKeep extends GOTStructureNorthBase {
	public static GOTStructureCrasterKeep INSTANCE = new GOTStructureCrasterKeep(false);
	public boolean hasStoneBase;
	public boolean setHasBase = false;

	public GOTStructureCrasterKeep(boolean flag) {
		super(flag);
	}
	...
	public GOTStructureCrasterKeep setHasBase(boolean flag) {
		hasStoneBase = flag;
		setHasBase = true;
		return this;
	}
	...
	public static boolean generatesAt(World world, int i, int k) {
		return GOTFixedStructures.generatesAtMapImageCoords(i, k, 717, 587);
	}
}
