...
public class GOTWaypointCrownlandsTown extends GOTVillageGen {
	public GOTWaypointCrownlandsTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointCrownlandsTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
