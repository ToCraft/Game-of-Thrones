...
public class GOTStructureTargaryenBarn extends GOTStructureTargaryenBase {
	public GOTStructureTargaryenBarn(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityTargaryenFarmer farmer = new GOTEntityTargaryenFarmer(world);
