...
import got.common.world.structure.westeros.gift.GOTStructureGiftBase;
import net.minecraft.init.Blocks;
import net.minecraft.world.World;

public class GOTStructureCastleBlack extends GOTStructureGiftBase {
	public GOTStructureCastleBlack(boolean flag) {
		super(flag);
	}
	...
	public static boolean generatesAt(World world, int i, int k) {
		return GOTFixedStructures.generatesAtMapImageCoords(i, k, 762, 635);
	}
}
