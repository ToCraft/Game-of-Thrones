...
public class GOTStructureShadowTower extends GOTStructureGiftBase {
	public GOTStructureShadowTower(boolean flag) {
		super(flag);
	}
	...
	public static boolean generatesAt(World world, int i, int k) {
		return GOTFixedStructures.generatesAtMapImageCoords(i, k, 680, 635);
	}
}
