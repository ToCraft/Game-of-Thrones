...
public class GOTStructureTargaryenStoneHouse extends GOTStructureTargaryenBase {
	public GOTStructureTargaryenStoneHouse(boolean flag) {
		super(flag);
	}
	...
	public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
		...
		GOTEntityTargaryenMan male = new GOTEntityTargaryenMan(world);
		male.familyInfo.setMale(true);
		male.setCurrentItemOrArmor(4, new ItemStack(GOTRegistry.goldRing));
		spawnNPCAndSetHome(male, world, 0, 1, 0, 16);
		GOTEntityTargaryenMan female = new GOTEntityTargaryenMan(world);
		...
		GOTEntityTargaryenMan child = new GOTEntityTargaryenMan(world);
