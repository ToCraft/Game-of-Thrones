...
public class GOTWaypointIronbornCastle extends GOTVillageGen {
	public GOTWaypointIronbornCastle(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointIronbornCastle village, World world, int i, int k, Random random, GOTLocationInfo loc) {
