...
public abstract class GOTStructureTargaryenVillageFarm extends GOTStructureTargaryenBase {
	public GOTStructureTargaryenVillageFarm(boolean flag) {
		super(flag);
	}
	...
	public static class Animals extends GOTStructureTargaryenVillageFarm {
		...
		public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
			...
			for (int l = 0; l < animals; ++l) {
				EntityAnimal animal = GOTStructureTargaryenBarn.getRandomAnimal(world, random);
	...
	public static class Crops extends GOTStructureTargaryenVillageFarm {
	...
	public static class Tree extends GOTStructureTargaryenVillageFarm {
