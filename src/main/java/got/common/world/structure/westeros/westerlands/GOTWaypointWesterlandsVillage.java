...
public class GOTWaypointWesterlandsVillage extends GOTVillageGen {
	public GOTWaypointWesterlandsVillage(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointWesterlandsVillage village, World world, int i, int k, Random random, GOTLocationInfo loc) {
