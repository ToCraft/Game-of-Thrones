...
public class GOTWaypointRiverlandsVillage extends GOTVillageGen {
	public GOTWaypointRiverlandsVillage(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointRiverlandsVillage village, World world, int i, int k, Random random, GOTLocationInfo loc) {
