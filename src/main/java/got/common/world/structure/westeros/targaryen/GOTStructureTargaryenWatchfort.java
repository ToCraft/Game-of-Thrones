...
public class GOTStructureTargaryenWatchfort extends GOTStructureTargaryenBase {
	public GOTStructureTargaryenWatchfort(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 7, -5, GOTItemBanner.BannerType.TARGARYEN, 2);
		for (i1 = -1; i1 <= 1; ++i1) {
			for (k12 = -7; k12 <= -6; ++k12) {
		...
		this.placeBanner(world, -2, 14, 11, GOTItemBanner.BannerType.TARGARYEN, 3);
		this.placeBanner(world, 2, 14, 11, GOTItemBanner.BannerType.TARGARYEN, 1);
		this.placeBanner(world, -2, 14, 23, GOTItemBanner.BannerType.TARGARYEN, 3);
		this.placeBanner(world, 2, 14, 23, GOTItemBanner.BannerType.TARGARYEN, 1);
		...
		setBlockAndMetadata(world, 2, 14, 18, Blocks.torch, 3);
		GOTStructureTargaryenTower beaconTower = new GOTStructureTargaryenTower(notifyChanges);
		...
		setAir(world, 1, 12, 29);
		GOTEntityTargaryenSoldier soldier = new GOTEntityTargaryenSoldier(world);
		soldier.spawnRidingHorse = false;
		spawnNPCAndSetHome(soldier, world, 0, 2, -3, 32);
		GOTEntityTargaryenCaptain captain = new GOTEntityTargaryenCaptain(world);
		captain.spawnRidingHorse = false;
		spawnNPCAndSetHome(captain, world, 0, 15, 0, 8);
		GOTEntityNPCRespawner respawner = new GOTEntityNPCRespawner(world);
		respawner.setSpawnClasses(GOTEntityTargaryenSoldier.class, GOTEntityTargaryenSoldierArcher.class);
