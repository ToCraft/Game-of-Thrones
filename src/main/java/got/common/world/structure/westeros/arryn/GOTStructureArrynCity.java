...
public class GOTStructureArrynCity extends GOTVillageGen {
	public static int INNER_MAX = 20;
	public static int OUTER_MIN = 53;
	public static int OUTER_MAX = 60;
	public static int SPOKE_WIDTH = 2;
	public static int PATH_FUZZ = 4;
	public static int FORT_WALL_Z = 37;
	public static int FORT_WALL_CENTRE_X = 11;
	public static int FORT_WALL_CORNER = 30;
	public static int TOWER_X = 23;
	public static int TOWER_Z = 33;
	public static int SIGN_R = 50;
	public static int SIGN_DISP = 7;
