...
public class GOTStructureKingsLandingTargaryen extends GOTVillageGen {
	public GOTStructureKingsLandingTargaryen(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTStructureKingsLandingTargaryen village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void addVillageStructures(Random random) {
			...
			this.addStructure(new GOTStructureTobhoMottSmithyTargaryen(false), 1, -37, 0, true);
