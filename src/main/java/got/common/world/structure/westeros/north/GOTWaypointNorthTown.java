...
public class GOTWaypointNorthTown extends GOTVillageGen {
	public GOTWaypointNorthTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointNorthTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
