...
public class GOTWaypointTargaryenCastle extends GOTVillageGen {
	public GOTWaypointTargaryenCastle(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointTargaryenCastle village, World world, int i, int k, Random random, GOTLocationInfo loc) {
