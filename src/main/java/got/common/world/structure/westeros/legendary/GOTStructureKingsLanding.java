...
public class GOTStructureKingsLanding extends GOTVillageGen {
	public GOTStructureKingsLanding(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTStructureKingsLanding village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void addVillageStructures(Random random) {
			this.addStructure(new GOTSpawner.SansaStark(false), 0, 0, 0);
