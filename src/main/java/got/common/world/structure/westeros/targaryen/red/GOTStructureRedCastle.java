...
public class GOTStructureRedCastle extends GOTVillageGen {
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTStructureRedCastle village, World world, int i, int k, Random random, GOTLocationInfo loc) {
		...
		public void addVillageStructures(Random random) {
			this.addStructure(new GOTStructureRedFortress(false), 0, 12, 2, true);
