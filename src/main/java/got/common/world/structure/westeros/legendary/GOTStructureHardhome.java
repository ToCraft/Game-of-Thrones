...
public class GOTStructureHardhome extends GOTStructureBase {
	...
	public GOTStructureHardhome(boolean flag) {
		super(flag);
	}
	...
	public static boolean generatesAt(World world, int i, int k) {
		return GOTFixedStructures.generatesAtMapImageCoords(i, k, 863, 541);
	}
}
