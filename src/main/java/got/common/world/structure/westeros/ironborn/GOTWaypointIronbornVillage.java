...
public class GOTWaypointIronbornVillage extends GOTVillageGen {
	public GOTWaypointIronbornVillage(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointIronbornVillage village, World world, int i, int k, Random random, GOTLocationInfo loc) {
