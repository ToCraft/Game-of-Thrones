...
public class GOTWaypointWesterlandsCastle extends GOTVillageGen {
	public GOTWaypointWesterlandsCastle(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointWesterlandsCastle village, World world, int i, int k, Random random, GOTLocationInfo loc) {
