...
public class GOTWaypointReachTown extends GOTVillageGen {
	public GOTWaypointReachTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointReachTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
