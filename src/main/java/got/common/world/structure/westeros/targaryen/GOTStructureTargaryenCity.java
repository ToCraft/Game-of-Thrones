...
public class GOTStructureTargaryenCity extends GOTVillageGen {
	private boolean isTown;
	private boolean isCastle;
	private boolean isCapital;

	public GOTStructureTargaryenCity(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public GOTStructureTargaryenCity setIsCapital() {
		isCapital = true;
		return this;
	}

	public GOTStructureTargaryenCity setIsCastle() {
		isCastle = true;
		return this;
	}

	public GOTStructureTargaryenCity setIsTown() {
		isTown = true;
		return this;
	}
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTStructureTargaryenCity village, World world, int i, int k, Random random, LocationInfo loc) {
		...
		public GOTStructureBase getRandomFarm(Random random) {
			if (random.nextBoolean()) {
				if (random.nextBoolean()) {
					return new GOTStructureTargaryenVillageFarm.Animals(false);
				}
				return new GOTStructureTargaryenVillageFarm.Crops(false);
			}
			return new GOTStructureTargaryenVillageFarm.Tree(false);
		}
		...
		public GOTStructureBase getRandomHouse(Random random) {
			if (random.nextInt(5) == 0) {
				...
				switch (i) {
				case 0:
					return new GOTStructureTargaryenStables(false);
				case 1:
					return new GOTStructureTargaryenSmithy(false);
				case 2:
					return new GOTStructureTargaryenBarn(false);
				default:
					break;
				}
			}
			return new GOTStructureTargaryenHouse(false);
		}
		...
		public void setupCastle(Random random) {
			...
			this.addStructure(new GOTStructureTargaryenFortress(false), 0, 12, 2, true);
			...
			this.addStructure(new GOTStructureTargaryenWatchtower(false), -23, -33, 2, true);
			this.addStructure(new GOTStructureTargaryenWatchtower(false), 23, -33, 2, true);
			...
			this.addStructure(new GOTStructureTargaryenWatchtower(false), -33, -23, 1, true);
			this.addStructure(new GOTStructureTargaryenWatchtower(false), -33, 23, 1, true);
			...
			this.addStructure(new GOTStructureTargaryenWatchtower(false), -23, 33, 0, true);
			this.addStructure(new GOTStructureTargaryenWatchtower(false), 23, 33, 0, true);
			...
			this.addStructure(new GOTStructureTargaryenWatchtower(false), 33, -23, 3, true);
			this.addStructure(new GOTStructureTargaryenWatchtower(false), 33, 23, 3, true);
			...
			this.addStructure(new GOTStructureTargaryenStables(false), -24, 2, 0);
			this.addStructure(new GOTStructureTargaryenStables(false), -24, -2, 2);
			this.addStructure(new GOTStructureTargaryenSmithy(false), 24, 1, 0);
			this.addStructure(new GOTStructureTargaryenSmithy(false), 24, -1, 2);
			this.addStructure(new GOTStructureTargaryenStoneHouse(false), -3, -25, 1);
			this.addStructure(new GOTStructureTargaryenStoneHouse(false), 3, -25, 3);
			this.addStructure(new GOTStructureTargaryenVillageFarm.Crops(false), -18, -21, 1);
			this.addStructure(new GOTStructureTargaryenVillageFarm.Crops(false), 18, -21, 3);
		...
		public void setupTown(Random random) {
			...
			if (isCapital) {
				...
				this.addStructure(new GOTStructureNPCRespawner(false) {
					...
					@Override
					public void setupRespawner(GOTEntityNPCRespawner spawner) {
						spawner.setSpawnClass(GOTEntityTargaryenAlchemist.class);
			...
			this.addStructure(new GOTStructureTargaryenGatehouse(false), 0, 84, 2, true);
			this.addStructure(new GOTStructureWesterosLampPost(false), -4, 73, 0, true);
			this.addStructure(new GOTStructureWesterosLampPost(false), 4, 73, 0, true);
			int towerX = 78;
			int towerZ = 74;
			for (int i1 : new int[] { -towerX, towerX }) {
				this.addStructure(new GOTStructureTargaryenWatchtower(false), i1, -towerZ, 2, true);
				this.addStructure(new GOTStructureTargaryenWatchtower(false), i1, towerZ, 0, true);
			}
			int wallZ = 82;
			int wallEndX = 76;
			for (l = 0; l <= 3; ++l) {
		...
		public void setupVillage(Random random) {
			...
			this.addStructure(new GOTStructureTargaryenCottage(false), -21, 0, 1);
			this.addStructure(new GOTStructureTargaryenCottage(false), 0, -21, 2);
			this.addStructure(new GOTStructureTargaryenCottage(false), 21, 0, 3);
			this.addStructure(new GOTStructureTargaryenTavern(false), 0, 21, 0);
			if (random.nextBoolean()) {
				if (random.nextInt(3) == 0) {
					this.addStructure(GOTStructureTargaryenMarketStall.getRandomStall(random, false), -9, -12, 1);
				}
				if (random.nextInt(3) == 0) {
					this.addStructure(GOTStructureTargaryenMarketStall.getRandomStall(random, false), 9, -12, 3);
				}
				if (random.nextInt(3) == 0) {
					this.addStructure(GOTStructureTargaryenMarketStall.getRandomStall(random, false), -9, 12, 1);
				}
