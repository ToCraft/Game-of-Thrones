...
import got.common.world.structure.westeros.targaryen.GOTStructureTargaryenBase;
import net.minecraft.item.ItemStack;
import net.minecraft.world.World;

public class GOTStructureTobhoMottSmithyTargaryen extends GOTStructureTargaryenBase {
	public GOTStructureTobhoMottSmithyTargaryen(boolean flag) {
		super(flag);
	}
	...
	public ItemStack getRandomWeapon(Random random) {
		ItemStack[] items = new ItemStack[] { new ItemStack(GOTRegistry.westerosSword), new ItemStack(GOTRegistry.westerosDagger), new ItemStack(GOTRegistry.westerosDaggerPoisoned), new ItemStack(GOTRegistry.westerosSpear), new ItemStack(GOTRegistry.westerosHammer) };
		return items[random.nextInt(items.length)].copy();
	}

	public static boolean generatesAt(World world, int i, int k) {
		return GOTFixedStructures.generatesAtMapImageCoords(i, k, 764, 1632);
	}
}
