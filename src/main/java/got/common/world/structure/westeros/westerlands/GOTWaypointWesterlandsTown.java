...
public class GOTWaypointWesterlandsTown extends GOTVillageGen {
	public GOTWaypointWesterlandsTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointWesterlandsTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
