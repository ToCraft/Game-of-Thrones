...
public class GOTStructureCrasterBarn extends GOTStructureNorthBase {
	public GOTStructureCrasterBarn(boolean flag) {
		super(flag);
	}
		...
		for (k1 = 3; k1 <= 12; ++k1) {
			...
			for (i12 = -4; i12 <= 4; ++i12) {
				...
				if (k2 == 2) {
					...
					if (i2 == 3) {
						EntityAnimal animal = GOTStructureCrasterBarn.getRandomAnimal(world, random);
