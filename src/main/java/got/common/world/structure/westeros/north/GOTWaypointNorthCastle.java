...
public class GOTWaypointNorthCastle extends GOTVillageGen {
	public GOTWaypointNorthCastle(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointNorthCastle village, World world, int i, int k, Random random, GOTLocationInfo loc) {
