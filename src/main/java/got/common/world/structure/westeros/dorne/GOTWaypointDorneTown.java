...
public class GOTWaypointDorneTown extends GOTVillageGen {
	public GOTWaypointDorneTown(GOTBiome biome, float f) {
		super(biome);
		gridScale = 16;
	...
	public class Instance extends GOTVillageGen.AbstractInstance {
		...
		public Instance(GOTWaypointDorneTown village, World world, int i, int k, Random random, GOTLocationInfo loc) {
