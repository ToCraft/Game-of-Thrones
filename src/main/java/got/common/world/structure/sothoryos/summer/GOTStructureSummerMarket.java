...
public class GOTStructureSummerMarket extends GOTStructureSummerBase {
	public static Class[] stalls = new Class[] { Brewer.class, Fish.class, Butcher.class, Baker.class, Lumber.class, Miner.class, Mason.class, Hunter.class, Blacksmith.class, Farmer.class };
	...
	public static class Farmer extends GOTStructureBase {
		...
		public ItemStack getRandomFarmFood(Random random) {
			ItemStack[] items = new ItemStack[] { new ItemStack(GOTRegistry.orange), new ItemStack(GOTRegistry.lemon), new ItemStack(GOTRegistry.lime), new ItemStack(Items.carrot), new ItemStack(Items.potato), new ItemStack(GOTRegistry.lettuce), new ItemStack(GOTRegistry.turnip) };
