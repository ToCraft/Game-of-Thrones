...
public class GOTStructureSothoryosSmithy extends GOTStructureSothoryosHouse {
	...
	public ItemStack getRandomSothoryosWeapon(Random random) {
		ItemStack[] items = new ItemStack[] { new ItemStack(GOTRegistry.sothoryosSword), new ItemStack(GOTRegistry.sothoryosDagger), new ItemStack(GOTRegistry.sothoryosSpear), new ItemStack(GOTRegistry.sothoryosPike), new ItemStack(GOTRegistry.sothoryosHammer), new ItemStack(GOTRegistry.sothoryosBattleaxe) };
