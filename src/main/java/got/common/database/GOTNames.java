...
public class GOTNames {
	...
	public static String getAsshaiName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "asshai_male" : "asshai_female", rand);
		return name;
	}

	public static String getEssosName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "essos_male" : "essos_female", rand);
		return name;
	}

	public static String getGhiscarName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "ghiscar_male" : "ghiscar_female", rand);
		return name;
	}
	...
	public static String getMaesterName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "maester" : "maester", rand);
		return name;
	}
	...
	public static String getNomadName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "nomad_male" : "nomad_female", rand);
		return name;
	}
	...
	public static String getSothoryosName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "sothoryos_male" : "sothoryos_female", rand);
		return name;
	}
	...
	public static String getWesterosName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "westeros_male" : "westeros_female", rand);
		return name;
	}

	public static String getWildName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "wild_male" : "wild_female", rand);
		return name;
	}

	public static String getYiTiName(Random rand, boolean male) {
		String name = GOTNames.getRandomName(male ? "yiti_male" : "yiti_female", rand);
		return name;
	}
