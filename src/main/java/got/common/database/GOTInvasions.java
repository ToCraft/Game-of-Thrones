...
public enum GOTInvasions {
	...
	public static void preInit() {
		...
		GOTInvasions.TARGARYEN.invasionIcon = GOTRegistry.rhaegarSword;
		...
		GOTInvasions.YI_TI.invasionMobs.add(new InvasionSpawnEntry(GOTEntityYiTiLevyman.class, 15));
		GOTInvasions.YI_TI.invasionMobs.add(new InvasionSpawnEntry(GOTEntityYiTiWarrior.class, 10));
		GOTInvasions.YI_TI.invasionMobs.add(new InvasionSpawnEntry(GOTEntityYiTiSamurai.class, 10));
		GOTInvasions.YI_TI.invasionMobs.add(new InvasionSpawnEntry(GOTEntityYiTiArcher.class, 5));
		GOTInvasions.YI_TI.invasionMobs.add(new InvasionSpawnEntry(GOTEntityYiTiFireThrower.class, 5));
		GOTInvasions.YI_TI.invasionMobs.add(new InvasionSpawnEntry(GOTEntityYiTiBannerBearer.class, 2));
		GOTInvasions.VOLANTIS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityVolantisWarrior.class, 10));
		GOTInvasions.VOLANTIS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityVolantisArcher.class, 5));
		GOTInvasions.VOLANTIS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityVolantisLegionary.class, 3));
		...
		GOTInvasions.BRAAVOS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityBraavosWarrior.class, 10));
		GOTInvasions.BRAAVOS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityBraavosArcher.class, 5));
		GOTInvasions.BRAAVOS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityBraavosLegionary.class, 3));
		GOTInvasions.BRAAVOS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityBraavosBannerBearer.class, 2));
		GOTInvasions.NORVOS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityNorvosWarrior.class, 10));
		GOTInvasions.NORVOS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityNorvosArcher.class, 5));
		GOTInvasions.NORVOS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityNorvosBannerBearer.class, 2));
		GOTInvasions.TYROSH.invasionMobs.add(new InvasionSpawnEntry(GOTEntityTyroshWarrior.class, 10));
		GOTInvasions.TYROSH.invasionMobs.add(new InvasionSpawnEntry(GOTEntityTyroshArcher.class, 5));
		GOTInvasions.TYROSH.invasionMobs.add(new InvasionSpawnEntry(GOTEntityTyroshLegionary.class, 3));
		GOTInvasions.TYROSH.invasionMobs.add(new InvasionSpawnEntry(GOTEntityTyroshBannerBearer.class, 2));
		GOTInvasions.MYR.invasionMobs.add(new InvasionSpawnEntry(GOTEntityMyrWarrior.class, 10));
		GOTInvasions.MYR.invasionMobs.add(new InvasionSpawnEntry(GOTEntityMyrArcher.class, 5));
		GOTInvasions.MYR.invasionMobs.add(new InvasionSpawnEntry(GOTEntityMyrLegionary.class, 3));
		GOTInvasions.MYR.invasionMobs.add(new InvasionSpawnEntry(GOTEntityMyrBannerBearer.class, 2));
		GOTInvasions.LYS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityLysWarrior.class, 10));
		GOTInvasions.LYS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityLysArcher.class, 5));
		GOTInvasions.LYS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityLysLegionary.class, 3));
		...
		GOTInvasions.PENTOS.invasionMobs.add(new InvasionSpawnEntry(GOTEntityPentosArcher.class, 5));
		...
		GOTInvasions.TARGARYEN.invasionMobs.add(new InvasionSpawnEntry(GOTEntityTargaryenSoldier.class, 10));
		GOTInvasions.TARGARYEN.invasionMobs.add(new InvasionSpawnEntry(GOTEntityTargaryenSoldierArcher.class, 5));
		GOTInvasions.TARGARYEN.invasionMobs.add(new InvasionSpawnEntry(GOTEntityTargaryenBannerBearer.class, 2));
