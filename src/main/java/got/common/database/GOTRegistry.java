...
public class GOTRegistry {
	...
	public static Item whiteWalkersHoe;
	...
	public static Item yitiBootsGold;
	...
	public static void assignContent() {
		...
		essosBow = new GOTItemBow(GOTMaterial.VOLANTIS, 1.1).setDrawTime(25);
		...
		lhazarBattleaxe = new GOTItemBattleaxe(GOTMaterial.LHAZAR);
		...
		lhazarClub = new GOTItemHammer(GOTMaterial.LHAZAR);
		lhazarDagger = new GOTItemDagger(GOTMaterial.LHAZAR);
		lhazarDaggerPoisoned = new GOTItemDagger(GOTMaterial.LHAZAR, GOTItemDagger.DaggerEffect.POISON);
		...
		lhazarSpear = new GOTItemSpear(GOTMaterial.LHAZAR);
		lhazarSword = new GOTItemSword(GOTMaterial.LHAZAR);
		...
		mossovySword = new GOTItemLegendarySword(GOTMaterial.SILVER).setCreativeTab(GOTCreativeTabs.tabCombat);
		...
		nomadBattleaxe = new GOTItemBattleaxe(GOTMaterial.DOTHRAKI);
		nomadBow = new GOTItemBow(GOTMaterial.DOTHRAKI);
		nomadSpear = new GOTItemSpear(GOTMaterial.DOTHRAKI);
		nomadSword = new GOTItemSword(GOTMaterial.DOTHRAKI);
		...
		cobaltBlue = new Item().setCreativeTab(GOTCreativeTabs.tabMaterials);
		...
		sothoryosAxe = new GOTItemAxe(GOTMaterial.SOTHORYOS);
		sothoryosBattleaxe = new GOTItemBattleaxe(GOTMaterial.SOTHORYOS);
		sothoryosSarbacane = new GOTItemSarbacane(GOTMaterial.SOTHORYOS);
		...
		sothoryosDagger = new GOTItemDagger(GOTMaterial.SOTHORYOS);
		sothoryosDaggerPoisoned = new GOTItemDagger(GOTMaterial.SOTHORYOS, GOTItemDagger.DaggerEffect.POISON);
		sothoryosDoubleTorchItem = new GOTItemDoubleTorch(sothoryosDoubleTorch).setCreativeTab(GOTCreativeTabs.tabDeco);
		sothoryosHammer = new GOTItemHammer(GOTMaterial.SOTHORYOS);
		...
		sothoryosHoe = new GOTItemHoe(GOTMaterial.SOTHORYOS);
		...
		sothoryosPickaxe = new GOTItemPickaxe(GOTMaterial.SOTHORYOS);
		sothoryosPike = new GOTItemPike(GOTMaterial.SOTHORYOS);
		sothoryosShovel = new GOTItemShovel(GOTMaterial.SOTHORYOS);
		sothoryosSpear = new GOTItemSpear(GOTMaterial.SOTHORYOS);
		sothoryosSword = new GOTItemSword(GOTMaterial.SOTHORYOS);
		...
		summerDagger = new GOTItemDagger(GOTMaterial.SUMMER);
		summerDaggerPoisoned = new GOTItemDagger(GOTMaterial.SUMMER, GOTItemDagger.DaggerEffect.POISON);
		summerHelmet = new GOTItemArmor(GOTMaterial.SUMMER, 0, "helmet");
		summerLeggings = new GOTItemArmor(GOTMaterial.SUMMER, 2);
		summerPike = new GOTItemPike(GOTMaterial.SUMMER);
		summerSpear = new GOTItemSpear(GOTMaterial.SUMMER);
		summerSword = new GOTItemSword(GOTMaterial.SUMMER);
		...
		whiteWalkersHoe = new GOTItemHoe(GOTMaterial.ICE).setCreativeTab(GOTCreativeTabs.tabStory);
		...
		wildlingAxe = new GOTItemAxe(GOTMaterial.WILDLING);
		wildlingBattleaxe = new GOTItemBattleaxe(GOTMaterial.WILDLING);
		wildlingDagger = new GOTItemDagger(GOTMaterial.WILDLING);
		wildlingDaggerPoisoned = new GOTItemDagger(GOTMaterial.WILDLING, GOTItemDagger.DaggerEffect.POISON);
		wildlingHammer = new GOTItemHammer(GOTMaterial.WILDLING);
		wildlingPolearm = new GOTItemPolearm(GOTMaterial.WILDLING);
		wildlingSpear = new GOTItemSpear(GOTMaterial.WILDLING);
		wildlingSword = new GOTItemSword(GOTMaterial.WILDLING);
		...
		yitiBootsGold = new GOTItemArmor(GOTMaterial.YITI_SAMURAI, 3);
	...
	public static void registerItems() {
		...
		registerItem(cobaltBlue, "cobaltBlue");
		...
		registerItem(yitiBootsGold, "yitiBootsSamurai");
		...
		registerItem(whiteWalkersHoe, "whiteWalkersHoe");
