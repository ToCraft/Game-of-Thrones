	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		if (costText != null) {
			...
			if (fontRendererObj.getUnicodeFlag()) {
				GOTGuiAnvil.drawRect(x - 3, y - 2, xSize - 7, y + 10, -16777216);
				GOTGuiAnvil.drawRect(x - 2, y - 1, xSize - 8, y + 9, -12895429);
			} else {
		...
		if (theAnvil.clientReforgeTime > 0) {
			...
			GOTGuiAnvil.drawRect(slot.xDisplayPosition, slot.yDisplayPosition, slot.xDisplayPosition + 16, slot.yDisplayPosition + 16, overlayColor);
		}
	}
