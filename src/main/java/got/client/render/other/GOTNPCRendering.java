...
public class GOTNPCRendering {
	...
	public static void renderHiredIcon(EntityLivingBase entity, double d, double d1, double d2) {
		if (!GOTConfig.hiredUnitIcons) {
			return;
		}
		if (entity.riddenByEntity instanceof GOTEntityNPC) {
			return;
		}
		if (entity instanceof GOTEntityNPC && GOTSpeechClient.hasSpeech((GOTEntityNPC) entity)) {
			return;
		}
		Minecraft mc = Minecraft.getMinecraft();
		WorldClient world = mc.theWorld;
	...
	public static void renderNPCHealthBar(EntityLivingBase entity, double d, double d1, double d2) {
		if (!GOTConfig.hiredUnitHealthBars) {
			return;
		}
		if (entity.riddenByEntity instanceof GOTEntityNPC) {
			return;
