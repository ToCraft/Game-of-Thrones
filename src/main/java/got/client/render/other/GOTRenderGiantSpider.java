...
public class GOTRenderGiantSpider extends GOTRenderSpiderBase {
	public static ResourceLocation[] spiderSkins = new ResourceLocation[] { new ResourceLocation("got:mob/ulthos/spider.png"), new ResourceLocation("got:mob/ulthos/spiderSlowness.png"), new ResourceLocation("got:mob/ulthos/spiderPoison.png") };
