...
public class GOTRenderSignCarved extends TileEntitySpecialRenderer {
	public static Map<IIcon, Integer> iconAverageColors = new HashMap<>();
	public static Map<IIcon, Integer> iconContrastColors = new HashMap<>();
	...
	public int calculateContrast(int color) {
