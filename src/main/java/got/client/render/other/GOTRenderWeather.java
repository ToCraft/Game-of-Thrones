		...
		if (rainStrength > 0.0f) {
			...
			for (int l = i3 - b0; l <= i3 + b0; ++l) {
				for (int i1 = k2 - b0; i1 <= k2 + b0; ++i1) {
					...
					boolean ashy = biomegenbase instanceof GOTBiomeShadowLand || biomegenbase instanceof GOTBiomeShadowMountains || biomegenbase instanceof GOTBiomeValyria || biomegenbase instanceof GOTBiomeShadowWasteland || biomegenbase instanceof GOTBiomeYeen;
