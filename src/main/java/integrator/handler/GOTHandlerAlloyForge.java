...
public class GOTHandlerAlloyForge extends TemplateRecipeHandler {
	...
	public ArrayList<GOTHandlerAlloyForge.CachedForgeRecipe> getAlloySmeltingRecipes(final ItemStack result) {
		...
		if (NEIServerUtils.areStacksSameTypeCrafting(result, new ItemStack(GOTRegistry.alloySteelIgnot))) {
			final GOTHandlerAlloyForge.CachedForgeRecipe rec1 = new GOTHandlerAlloyForge.CachedForgeRecipe(new ItemStack[] { new ItemStack(GOTRegistry.cobaltBlue) }, new ItemStack[] { new ItemStack(Items.iron_ingot) }, result);
			final GOTHandlerAlloyForge.CachedForgeRecipe rec2 = new GOTHandlerAlloyForge.CachedForgeRecipe(new ItemStack[] {new ItemStack(Items.iron_ingot) }, new ItemStack[] { new ItemStack(GOTRegistry.cobaltBlue) }, result);
			ret.add(rec1);
			ret.add(rec2);
		}
		return ret;
	...
	private void handlerCRStack(final Item forgeItem, final ItemStack result) {
